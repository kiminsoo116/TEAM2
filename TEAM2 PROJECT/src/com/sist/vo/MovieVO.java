...
public class MovieVO {
	...
	public String toString() {
		return "MovieVO [m_title=" + m_title + ", m_genre=" + m_genre + ", m_poster=" + m_poster + ", m_time=" + m_time
				+ ", m_director=" + m_director + ", m_cast=" + m_cast + ", m_rdate=" + m_rdate + ", m_rate=" + m_rate
				+ ", m_cnt=" + m_cnt + ", m_preview=" + m_preview + ", m_photo=" + m_photo + ", m_content=" + m_content
				+ "]";
	}
