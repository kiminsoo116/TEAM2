...
public class MovieSortVO {
	...
	private int m_no_1;
	private int coumoive;

	public int getCoumoive() {
		return coumoive;
	}

	public void setCoumoive(int coumoive) {
		this.coumoive = coumoive;
	}
	...
	public double getAvgmoive() {
		return avgmoive;
	}

	public void setAvgmoive(double avgmoive) {
		this.avgmoive = avgmoive;
	}

	public int getM_no_1() {
		return m_no_1;
	}

	public void setM_no_1(int m_no_1) {
		this.m_no_1 = m_no_1;
	}
